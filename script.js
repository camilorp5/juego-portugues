document.addEventListener('DOMContentLoaded', () => {
    ...
    const TILE_DISTRIBUTION = {
        ...
        'O': { count: 9, score: 1 }, 'S': { count: 6, score: 1 },
        'I': { count: 6, score: 1 }, 'U': { count: 5, score: 1 },
        'N': { count: 5, score: 1 }, 'L': { count: 4, score: 1 },
        'R': { count: 5, score: 1 }, 'T': { count: 4, score: 1 },
        'C': { count: 4, score: 3 }, 'D': { count: 5, score: 2 },
        'G': { count: 2, score: 2 }, 'B': { count: 2, score: 3 },
        'M': { count: 2, score: 3 }, 'P': { count: 2, score: 3 },
        'H': { count: 2, score: 4 }, 'F': { count: 1, score: 4 },
        'V': { count: 1, score: 4 }, 'Y': { count: 1, score: 4 },
        'Q': { count: 1, score: 5 }, // Nota: Q casi siempre necesita U
        'J': { count: 1, score: 8 }, 'Ñ': { count: 1, score: 8 },
        'X': { count: 1, score: 8 }, 'Z': { count: 1, score: 10 },
        // 'LL': { count: 1, score: 8 }, 'RR': { count: 1, score: 8 } // Opcional dígrafos
        // Comodines (Blanco) se podrían añadir como:
        // '_': { count: 2, score: 0 }
    };

    // Multiplicadores del tablero (fila, columna, tipo) - 0-indexed
    // Simplificado - añadir más según el estándar Scrabble si se desea
    ...
    const DICTIONARY = new Set([
         "SER", "ESTAR", "TER", "FAZER", "PODER", "DIZER", "IR", "VER", "DAR",
         "SABER", "QUERER", "CHEGAR", "PASSAR", "DEVER", "COLOCAR", "PARECER",
         "FICAR", "ACREDITAR", "FALAR", "LEVAR", "DEIXAR", "SEGUIR", "ENCONTRAR",
         "CHAMAR", "VIR", "PENSAR", "SAIR", "VOLTAR", "PEGAR", "CONHECER",
         "VIVER", "SENTIR", "TRATAR", "OLHAR", "CONTAR", "COMEÇAR", "ESPERAR",
